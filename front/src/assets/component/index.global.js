...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // BAD name for this class now. used in the EventHead
    ...
    */
        ...
        render() {
            ...
            return j(y("div", Object.assign({}, props.extraAttrs, { id: props.id, className: classNames.join(' '), "aria-labelledby": state.titleId, ref: this.handleRootEl }),
                y("div", { className: 'fc-popover-header ' + theme.getClass('popoverHeader') },
                    y("span", { className: "fc-popover-title", id: state.titleId }, day),
    ...
    class MoreLinkContainer extends BaseComponent {
        ...
        componentDidUpdate() {
            ...
            var popup = document.querySelector('.fc-popover');

            // if(popup){
            //     popup.style.left = 0; // x 좌표
            //     popup.style.top = '100px'; // y 좌표
            // }
        }
        updateParentEl() {
            if (this.linkEl) {
