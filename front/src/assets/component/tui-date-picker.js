...
var Calendar = defineClass(
  /** @lends Calendar.prototype */ {
    ...
    /**
     * Initialize header
     * @param {object} options - EventHead options
     * @private
     */
...
"use strict";
/**
 * @fileoverview Calendar EventHead
 */
 ...
 * @ignore
 * @class
 * @param {string|HTMLElement} container - EventHead container or selector
 * @param {object} option - EventHead option
 * @param {string} option.language - EventHead language
...
module.exports = function(context) {
  ...
  '      <button class="tui-calendar-btn tui-calendar-btn-prev-year tui-open">Prev year</button>' +
  '      <button class="tui-calendar-btn tui-calendar-btn-prev-month tui-open">Prev month</button>' +
  ...
  '      <button class="tui-calendar-btn tui-calendar-btn-prev-month tui-open">Prev month</button>' +
  '      <em class="tui-calendar-title {{titleClass}}">{{title}}</em>' +
  '      <button class="tui-calendar-btn tui-calendar-btn-next-month tui-open">Next month</button>' +
  '    </div>' +
  '  {{/if}}' +
  '{{else}}' +
  '  <div class="tui-calendar-header-inner">' +
  '    <button class="tui-calendar-btn tui-calendar-btn-prev-year tui-open">Prev year</button>' +
  '    <em class="tui-calendar-title {{titleClass}}">{{title}}</em>' +
  '    <button class="tui-calendar-btn tui-calendar-btn-next-year tui-open">Next year</button>' +
  '  </div>' +
  '{{/if}}' +
  '{{if showToday}}' +
...
function sendHostname(appName, trackingId) {
  ...
  var applicationKeyForStorage = 'TOAST UI ' + appName + ' for ' + hostname + ': StatRoot';
