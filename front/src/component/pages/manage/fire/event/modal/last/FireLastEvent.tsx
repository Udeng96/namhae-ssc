...
import FireLastEventHead from './FireLastEventHead';
import FireLastEventBody from './FireLastEventBody';

const FireLastEvent = () => {
  const {
    openOpt, setOpenOpt,
    setLastParam, setLastSelectEvent, setLastEventList, setLastTotalCnt,
    lastEventList,
  } = useFireStore(
    useShallow((state) => ({
