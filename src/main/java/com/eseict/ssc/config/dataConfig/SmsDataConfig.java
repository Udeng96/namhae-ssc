...
import static com.eseict.ssc.config.DbConstants.Sms.entity_manager_factory_ref;
import static com.eseict.ssc.config.DbConstants.Sms.transaction_manager_ref;

@Configuration
@EnableJpaRepositories(
        basePackages = {
                "com.eseict.ssc.repository.share.sms",
        },
...
public class SmsDataConfig {
    ...
    @Value("${spring.datasource.sms.jdbc-url}")
    String jdbcUrl;
    @Value("${spring.datasource.sms.username}")
    String userName;
    @Value("${spring.datasource.sms.password}")
    String password;
    @Value("${spring.datasource.sms.driver-class-name}")
    String driverName;
    @Value("${spring.datasource.sms.dialect}")
    ...
    public DataSource dataSource() {
        ...
        log.info("####################################################################################################################");
        log.info("## SSC SMS DataSource Info.");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(
            ...
            @Qualifier("smsDataSource") DataSource ds) {
