...
## 👤 담당 역할 (프로젝트 리더 · 풀스택 개발자 3명 중 리더)

- **사용 기술 선정, 일정·역할 분배 등 프로젝트 리딩**
- 개발 진행 관리 및 **PM과의 협의를 통한 네트워크·필요 API 분석**
- **대시보드 전반의 화면 구조 설계 및 기능 개발**
- 약 **3년간(2023.06 ~ 2026.03) 유지보수 포함** 장기 운영
